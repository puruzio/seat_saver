...
Elm.Main.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $SeatSaver_Pair = Elm.SeatSaver_Pair.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $SeatSaver_Pair.init,update: $SeatSaver_Pair.update,view: $SeatSaver_Pair.view,inputs: _U.list([])});
   var main = app.html;
